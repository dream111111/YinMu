<template>
	<div class="quanbu">
		<div class="quanbuCon">
			<div class="sousuo">
				<i class="search"></i>
				<input type="text" placeholder="搜索播放歌曲" />
			</div>
			<div class="content">
				<div class="left">
					<p>随机播放全部</p>
			...
			<a class="m-sgitem" href="#" v-for="(list,index) in listData">
				...
				<div class="sgfr f-bd f-bd-btm">
					<div class="sgchfl">
						...
						<div class="listened">{{list.musicCount}}</div>
					</div>
					<div class="sgchfr">
...
<script>
//	import zuijinbofang from "../../../assets/data/zuijinbofang.json"
	export default {
		name: "quanbu",
		data() {
			return {
		...
		created: function() {
			var currentUrl = this.HOST + "/yinmu/zuijinbofang.json";
			...
			.m-sgitem .sgchfl {
				...
				.listened{
					...
					&:before{
						...
						width: 0.4rem;
						height: 0.4rem;
						background: url(../../../assets/images/mine/erji.png)no-repeat;
						background-size: contain;
					}
				}
			}
